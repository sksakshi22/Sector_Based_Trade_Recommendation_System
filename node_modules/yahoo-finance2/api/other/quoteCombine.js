...
const quote_1 = __importDefault(require("../modules/quote"));
const validateAndCoerceTypes_1 = __importDefault(require("../lib/validateAndCoerceTypes"));
...
function quoteCombine(query, queryOptionsOverrides = {}, moduleOptions) {
    ...
    validateAndCoerceTypes_1.default({
        source: "quoteCombine",
        type: "options",
    ...
    const thisQuote = quote_1.default.bind(this);
