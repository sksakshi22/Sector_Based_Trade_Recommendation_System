...
const options = {
  ...
  qs: {
    region: 'IN',
    symbols: 'AXISBANK.NS,BAJFINANCE.NS,BAJAJFINSV.NS,CHOLAFIN.NS,HDFCAMC.NS,HDFCBANK.NS,HDFCLIFE.NS,HDFC.NS,ICICIBANK.NS,ICICIGI.NS,ICICIPRULI.NS,KOTAKBANK.NS,M&MFIN.NS,MUTHOOTFIN.NS,PEL.NS,PFC.NS,RECLTD.NS,SBILIFE.NS,SRTRANSFIN.NS,SBIN.NS'
  },
  headers: {
	...
	var obj1 = JSON.parse(body);
       ...
       // console.log(obj2);
        ...
        storePE.sort(function(a, b) {
          ...
          fs.writeFile('./TempFinanceStocks.js', jsonString, err => {
              if (err) {
