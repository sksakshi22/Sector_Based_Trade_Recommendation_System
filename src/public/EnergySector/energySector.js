...
const options = {
  ...
  qs: {
    region: 'IN',
    symbols: 'RELIANCE.NS,TATAPOWER.NS,POWERGRID.NS,ONGC.NS,IOC.NS,GAIL.NS,BPCL.NS,NTPC.NS,HINDPETRO.NS,ADANIENT.NS'
  },
  headers: {
...
request(options, function (error, response, body) {
  ...
  const jsonString = JSON.stringify(storePE)
          fs.writeFile('./TempEnergyStocks.js', jsonString, err => {
              if (err) {
