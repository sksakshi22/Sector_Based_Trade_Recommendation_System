...
const options = {
    ...
    qs: {
      region: 'IN',
      symbols: 'AMARAJABAT.NS,ASHOKLEY.NS,BAJAJ-AUTO.NS,BALKRISIND.NS,BHARATFORG.NS,BOSCHLTD.NS,EICHERMOT.NS,EXIDEIND.NS,HEROMOTOCO.NS,MRF.NS,M&M.NS,MARUTI.NS,MOTHERSUMI.NS,TVSMOTOR.NS,TATAMOTORS.NS,'
    },
    headers: {
  ...
  request(options, function (error, response, body) {
     ...
     // console.log(obj2);
      ...
      const jsonString = JSON.stringify(storePE)
          fs.writeFile('./TempAutomobileStocks.js', jsonString, err => {
              if (err) {
