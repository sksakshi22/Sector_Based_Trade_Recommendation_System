...
const options = {
    ...
    qs: {
      region: 'IN',
      symbols: 'ABBOTINDIA.NS,ALKEM.NS,APOLLOHOSP.NS,AUROPHARMA.NS,BIOCON.NS,CADILAHC.NS,CIPLA.NS,DIVISLAB.NS,LALPATHLAB.NS,DRREDDY.NS,FORTIS.NS,GLAXO.NS,GLENMARK.NS,IPCALAB.NS,LUPIN.NS,NATCOPHARM.NS,PFIZER.NS,SANOFI.NS,SUNPHARMA.NS,TORNTPHARM'
    },
    headers: {
      ...
      var obj1 = JSON.parse(body);
       ...
       // storePE.sort(compareName).reverse();
        storePE.sort(function(a, b) {
          ...
          fs.writeFile('./TempHealthcareStocks.js', jsonString, err => {
              if (err) {
